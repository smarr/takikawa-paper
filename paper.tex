...
Though though outliers, caused by \eg garbage collection, remain visible in the plots for each individual benchmark, the largest 95\% confidence interval we obtained for the arithmetic mean of any of the results for any of our experiments was $\pm3.53\%$ (for the PyStone benchmark). 

All experiments were executed on a Windows 10 machine
running Fedora 29 within Windows Subsystems for Linux (version 1). The machine has 

one Intel Core i7-6800K @3.40GHz, with 6 cores, for a total of 12 hyperthreads. We used ReBench 1.0 \citep{ReBench:2018}, Java 1.8.0\_191 Graal 0.43.
